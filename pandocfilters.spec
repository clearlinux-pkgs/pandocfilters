...
%prep
%setup -q -n pandocfilters-1.4.3
cd %{_builddir}/pandocfilters-1.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625014281
...
cp %{_builddir}/pandocfilters-1.4.3/LICENSE %{buildroot}/usr/share/package-licenses/pandocfilters/9990e0fc59b210f7995dbe22caeb082cae511080
